    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('password', models.CharField(default='mainpass', max_length=100, verbose_name='Password')),
                ('branch_of', models.ForeignKey(default=core.userSession.get_current_user_branch, editable=False, on_delete=django.db.models.deletion.PROTECT, to='branch.branch', verbose_name='Branch')),
                ('group_assigned', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='auth.group', verbose_name='User Group')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('branch', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.CASCADE, to='branch.branch', verbose_name='Service')),
